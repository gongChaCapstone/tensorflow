...
letterA.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpLeft, 0.9);
letterA.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpRight, 0.9);
...
for (let finger of [
  ...
  letterA.addDirection(finger, fp.FingerDirection.VerticalUp, 1.0);
