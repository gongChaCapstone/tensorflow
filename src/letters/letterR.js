...
const letterR = new fp.GestureDescription('letterR');

letterR.addCurl(fp.Finger.Thumb, fp.FingerCurl.NoCurl, 1.0);
letterR.addCurl(fp.Finger.Thumb, fp.FingerCurl.HalfCurl, 0.9);
letterR.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpRight, 1.0);
letterR.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpLeft, 1.0);

letterR.addCurl(fp.Finger.Index, fp.FingerCurl.NoCurl, 1.0);
letterR.addDirection(fp.Finger.Index, fp.FingerDirection.DiagonalUpLeft, 1.0);
letterR.addDirection(fp.Finger.Index, fp.FingerDirection.DiagonalUpRight, 1.0);
