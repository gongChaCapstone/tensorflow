...
const letterE = new fp.GestureDescription('letterE');

letterE.addCurl(fp.Finger.Thumb, fp.FingerCurl.HalfCurl);
...
letterE.addCurl(fp.Finger.Index, fp.FingerCurl.FullCurl);
letterE.addDirection(fp.Finger.Index, fp.FingerDirection.VerticalUp, 1.0);
letterE.addDirection(fp.Finger.Index, fp.FingerDirection.DiagonalUpRight, 0.9);
letterE.addDirection(fp.Finger.Index, fp.FingerDirection.DiagonalUpLeft, 0.9);

letterE.addCurl(fp.Finger.Middle, fp.FingerCurl.FullCurl);
