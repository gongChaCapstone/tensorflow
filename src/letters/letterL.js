...
const letterL = new fp.GestureDescription('letterL');

letterL.addCurl(fp.Finger.Thumb, fp.FingerCurl.NoCurl, 1.0);
letterL.addCurl(fp.Finger.Thumb, fp.FingerCurl.HalfCurl, 0.9);
...
letterL.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpRight, 0.9);
letterL.addDirection(fp.Finger.Thumb, fp.FingerDirection.DiagonalUpLeft, 0.9);
...
for (let finger of [fp.Finger.Ring, fp.Finger.Pinky, fp.Finger.Middle]) {
  ...
  letterL.addDirection(finger, fp.FingerDirection.HorizontalRight, 1.0);
  letterL.addDirection(finger, fp.FingerDirection.HorizontalLeft, 1.0);
}
